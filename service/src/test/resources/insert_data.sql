...
VALUES (1, (SELECT id FROM car_rent.user_details WHERE phone = '+375 29 124 56 78'), 'AB12345', '2015-03-02 00:00:00', '2025-03-01 00:00:00'),
       (2, (SELECT id FROM car_rent.user_details WHERE phone = '+375 29 124 56 79'), 'AB12346', '2014-03-02 00:00:00', '2024-12-01 00:00:00');
...
VALUES (1, (SELECT id FROM car_rent.brand WHERE name = 'audi'), (SELECT id FROM car_rent.category WHERE name = 'ECONOMY'), 'A8', 'MANUAL', 'FUEL'),
       (2, (SELECT id FROM car_rent.brand WHERE name = 'mercedes'), (SELECT id FROM car_rent.category WHERE name = 'BUSINESS'), 'Benz', 'ROBOT', 'FUEL');
...
VALUES (1, '2022-07-01 00:00:00', (SELECT id FROM car_rent.users WHERE email = 'admin@gmail.com'), (SELECT id FROM car_rent.car WHERE vin = 'AmhBHqJ8BgD0p3PRgkoi'), 'MP1234567', 'true', 'CONFIRMATION_WAIT', 1020),
       (2, '2022-07-02 00:00:00', (SELECT id FROM car_rent.users WHERE email = 'client@gmail.com'), (SELECT id FROM car_rent.car WHERE vin = 'AmhBdhjJ8BgD0p3PRgkoi'), 'MP1234589', 'true', 'PAYED', 300);
